...
export const deleteComment = createAsyncAction(DELETE_COMMENT.REQUEST, DELETE_COMMENT.SUCCESS, DELETE_COMMENT.FAILURE)<
...
export const saveComment = createAsyncAction(SAVE_COMMENT.REQUEST, SAVE_COMMENT.SUCCESS, SAVE_COMMENT.FAILURE)<
  SaveCommentPayload,
  CommentResponse,
  AxiosError
>();
