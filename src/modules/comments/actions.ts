...
export const fetchComments =
  createAsyncAction(
    FETCH_COMMENTS.REQUEST, FETCH_COMMENTS.SUCCESS, FETCH_COMMENTS.FAILURE
)<FetchCommentsPayload, CommentsResponse, AxiosError>()
...
export const searchComments =
  createAsyncAction(
    SEARCH_COMMENTS.REQUEST, SEARCH_COMMENTS.SUCCESS, SEARCH_COMMENTS.FAILURE
